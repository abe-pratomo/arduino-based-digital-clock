...
Lastly, you can find the reports (also note that they were written in Bahasa Indonesia as well), including the reports of the [design](docs/Laporan Proyek Jam Digital v1 - 13221051 - 13221087.pdf), of the [first implementation](docs/Laporan Proyek Jam Digital v2 - 13221051 - 13221087.pdf) which only had a simple clock mode, and of the [final implementation](docs/Laporan Proyek Jam Digital Final - 13221051 - 13221087.pdf) which had been completed with timer/alarm and stopwatch modes, inside the [docs](https://github.com/abe-pratomo/arduino-based-digital-clock/tree/85a2a71484c9189f11c33efd1d249a6488de6d89/docs) folder.
